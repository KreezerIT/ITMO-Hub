...
[Файл с полным ТЗ+Теория](OS_LabDescription_5.pdf)
...
Проводите наблюдения и фиксируйте их в отчете до **аварийной остановки процесса** и его исчезновения из перечня процессов в `top`.
...
последние две записи о скрипте в системном журнале и зафиксируйте их в отчете.  
...
Проводите наблюдения и фиксируйте их до **аварийной остановки последнего** из двух скриптов и их исчезновения из перечня процессов в `top`.
...
последние записи о скриптах в системном журнале и зафиксируйте их в отчете.  
Также зафиксируйте значения в **последних строках файлов** `report.log` и `report2.log`.

---

## Обработка результатов

Постройте **графики изменения** каждой из величин, за которыми производилось наблюдение на каждом из этапов. Объясните динамику изменения этих величин, исходя из **теоретических основ управления памятью** в рамках страничной **организации памяти** с использованием **раздела подкачки**. Объясните значения **пороговых величин**: размер массива, при котором произошла аварийная остановка процесса, параметры, зафиксированные в момент аварийной остановки системным журналом. Сформулируйте **письменные выводы**.
