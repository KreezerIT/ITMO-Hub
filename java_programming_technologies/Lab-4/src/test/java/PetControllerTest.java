...
public class PetControllerTest {
    ...
    public void testGetPets() throws Exception {
        ...
        mockMvc.perform(get("/api/pets").with(user("someUser").roles("ADMIN")))
    ...
    public void testCreatePet() throws Exception {
        ...
        mockMvc.perform(post("/api/pets").with(user("someUser").roles("ADMIN"))
    ...
    public void testUpdatePet() throws Exception {
        ...
        mockMvc.perform(put("/api/pets/1").with(user("someUser").roles("ADMIN"))
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json))
                .andExpect(status().isOk());
    }
    ...
    public void testGetPetById() throws Exception {
        ...
        mockMvc.perform(get("/api/pets/1").with(user("someUser").roles("ADMIN")))
                .andExpect(status().isOk())
    ...
    public void testDeletePetById() throws Exception {
        mockMvc.perform(delete("/api/pets/1").with(user("someUser").roles("ADMIN")))
    ...
    public void testGetPetsByName() throws Exception {
        ...
        mockMvc.perform(get("/api/pets/search/Buddy").with(user("someUser").roles("ADMIN")))
                .andExpect(status().isOk())
    ...
    public void testSearchPets() throws Exception {
        ...
        mockMvc.perform(get("/api/pets/search").with(user("someUser").roles("ADMIN"))
                        .param("color", "WHITE")
                        .param("breed", "Pug"))
                .andExpect(status().isOk())
